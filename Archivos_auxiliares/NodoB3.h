...
NodoB3<Dato, Clave>* NodoB3<Dato, Clave>:: agregar_elemento_existente( Elemento<Dato, Clave>* elemento_entrante ){
    ...
    else if( ( this -> elementos -> obtener_cantidad() == 1 ) || (elemento_entrante -> obtener_clave() <= this -> obtener_clave_de(2) )){
...
int NodoB3<Dato, Clave>                 :: clave_menor_entra_mayor( Clave clave ){
    ...
    else if (  ( clave == this -> obtener_clave_de(1) ) || (( this -> elementos -> obtener_cantidad() == 2) && ( clave <= this -> obtener_clave_de(2) )))
        clave_es = 1;
